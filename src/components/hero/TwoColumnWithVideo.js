...
const PrimaryButton = tw.button`font-bold px-8 lg:px-10 py-3 rounded bg-white text-primary-500 hocus:bg-primary-700 focus:shadow-outline focus:outline-none transition duration-300`;
const WatchVideoButton = styled.button`
  ${tw`mt-4 sm:mt-0 sm:ml-8 flex items-center text-white transition duration-300 hocus:text-primary-400 focus:outline-none`}
  .playIcon {
      ...
      <Container>
        <TwoColumn>
          ...
          <Heading>{heading}</Heading>
            ...
            <Actions>
              <PrimaryButton onClick={primaryButtonClickHandler}>{primaryButtonText}</PrimaryButton>
